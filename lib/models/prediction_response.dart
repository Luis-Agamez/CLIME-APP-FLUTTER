...
//
//     final predictionResponse = predictionResponseFromMap(jsonString);
...
class PredictionResponse {
  ...
  factory PredictionResponse.fromJson(String str) =>
      PredictionResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory PredictionResponse.fromMap(Map<String, dynamic> json) =>
      PredictionResponse(
        cod: json["cod"],
...
enum Icon { THE_03_D, THE_04_D, THE_04_N, THE_10_N, THE_10_D }
