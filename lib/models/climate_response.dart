...
//
//     final climateResponse = climateResponseFromMap(jsonString);
...
class ClimateResponse {
  ...
  factory ClimateResponse.fromJson(String str) =>
      ClimateResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory ClimateResponse.fromMap(Map<String, dynamic> json) => ClimateResponse(
